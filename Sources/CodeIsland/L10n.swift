...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "copilot_subagent_mode": "Copilot Subagents",
        "copilot_subagent_mode_desc": "How to show Copilot task subagents that report toolu_* session ids",
        "copilot_subagent_mode_merge": "Merge into parent",
        "copilot_subagent_mode_hide": "Hide",
        "copilot_permission_mode": "Copilot Permissions",
        "copilot_permission_mode_desc": "Choose how CodeIsland handles GitHub Copilot permission prompts",
        "copilot_permission_mode_intercept": "Intercept in CodeIsland",
        "copilot_permission_mode_headsUp": "Notify when Copilot asks",
        "copilot_permission_mode_off": "Off",
    ...
    private static let zh: [String: String] = [
        ...
        "copilot_subagent_mode": "Copilot 子代理",
        "copilot_subagent_mode_desc": "处理报告 toolu_* 会话 ID 的 Copilot task 子代理显示方式",
        "copilot_subagent_mode_merge": "合并到父会话",
        "copilot_subagent_mode_hide": "隐藏",
        "copilot_permission_mode": "Copilot 权限",
        "copilot_permission_mode_desc": "选择 CodeIsland 如何处理 GitHub Copilot 权限提示",
        "copilot_permission_mode_intercept": "在 CodeIsland 中拦截",
        "copilot_permission_mode_headsUp": "Copilot 询问时通知",
        "copilot_permission_mode_off": "关闭",
    ...
    private static let ja: [String: String] = [
        ...
        "copilot_subagent_mode": "Copilot サブエージェント",
        "copilot_subagent_mode_desc": "toolu_* セッション ID を報告する Copilot task サブエージェントの表示方法を選択します",
        "copilot_subagent_mode_merge": "親セッションに統合",
        "copilot_subagent_mode_hide": "非表示",
        "copilot_permission_mode": "Copilot の権限",
        "copilot_permission_mode_desc": "GitHub Copilot の権限プロンプトを CodeIsland がどう扱うかを選択します",
        "copilot_permission_mode_intercept": "CodeIsland でインターセプト",
        "copilot_permission_mode_headsUp": "Copilot が求めたときに通知",
        "copilot_permission_mode_off": "オフ",
        ...
        "reply_complete_placeholder": "[応答完了]",
        "task_error": "タスクエラー",
    ...
    private static let ko: [String: String] = [
        ...
        "copilot_subagent_mode": "Copilot 하위 에이전트",
        "copilot_subagent_mode_desc": "toolu_* 세션 ID를 보고하는 Copilot task 하위 에이전트 표시 방식",
        "copilot_subagent_mode_merge": "부모 세션으로 병합",
        "copilot_subagent_mode_hide": "숨김",
        "copilot_permission_mode": "Copilot 권한",
        "copilot_permission_mode_desc": "CodeIsland가 GitHub Copilot 권한 프롬프트를 처리하는 방식을 선택합니다",
        "copilot_permission_mode_intercept": "CodeIsland에서 가로채기",
        "copilot_permission_mode_headsUp": "Copilot이 요청할 때 알림",
        "copilot_permission_mode_off": "끄기",
        ...
        "reply_complete_placeholder": "[응답 완료]",
        "task_error": "작업 오류",
    ...
    private static let tr: [String: String] = [
        ...
        "copilot_subagent_mode": "Copilot Alt Ajanları",
        "copilot_subagent_mode_desc": "toolu_* oturum kimliği bildiren Copilot task alt ajanlarının nasıl gösterileceği",
        "copilot_subagent_mode_merge": "Üst oturuma birleştir",
        "copilot_subagent_mode_hide": "Gizle",
        "copilot_permission_mode": "Copilot İzinleri",
        "copilot_permission_mode_desc": "CodeIsland'ın GitHub Copilot izin istemlerini nasıl yöneteceğini seçin",
        "copilot_permission_mode_intercept": "CodeIsland'da yakala",
        "copilot_permission_mode_headsUp": "Copilot sorduğunda bildir",
        "copilot_permission_mode_off": "Kapalı",
